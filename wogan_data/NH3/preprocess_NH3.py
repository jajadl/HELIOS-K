...
def download_partition_functions():
    """Download partition function files for NH3 isotopologues"""
    os.makedirs('data', exist_ok=True)
    
    # NH3 isotopologues use q45.txt, q46.txt
    q_files = [45, 46]
...
def main():
    ...
    shutil.copy('downloads/11_HITRAN2016.par', 'extract/11_HITRAN2016.par')
