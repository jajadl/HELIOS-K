...
def download_partition_functions():
    """Download partition function files for SO2 isotopologues"""
    os.makedirs('data', exist_ok=True)
    
    # SO2 isotopologues use q42.txt, q43.txt, q137.txt, q138.txt
    q_files = [42, 43, 137, 138]
...
def main():
    ...
    shutil.copy('downloads/09_HITRAN2016.par', 'extract/09_HITRAN2016.par')
