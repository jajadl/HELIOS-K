...
def download_partition_functions():
    """Download partition function files for O3 isotopologues"""
    os.makedirs('data', exist_ok=True)
    
    # O3 isotopologues use q16.txt through q20.txt
    q_files = [16, 17, 18, 19, 20]
...
def main():
    ...
    shutil.copy('downloads/03_HITRAN2016.par', 'extract/03_HITRAN2016.par')
